...
public abstract class AbstractTrainingLoginPageController extends AbstractLoginPageController {
    ...
    protected String processRegisterUserRequest(String referer, TrainingRegisterForm form, BindingResult bindingResult,
        ...
        data.setRg(form.getRg());
        data.setBirthDate(form.getBirthDate());
        data.setPassword(form.getPwd());
        data.setTitleCode(form.getTitleCode());
        try
        {
            this.trainingCustomerFacade.register(data);
