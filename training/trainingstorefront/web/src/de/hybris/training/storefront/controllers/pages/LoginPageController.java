...
import de.hybris.training.storefront.controllers.pages.training.AbstractTrainingLoginPageController;
...
public class LoginPageController extends AbstractTrainingLoginPageController
{
	...
	private TrainingRegistrationValidator trainingRegistrationValidator;
	...
	{
		this.trainingRegistrationValidator.validate(form,bindingResult);
